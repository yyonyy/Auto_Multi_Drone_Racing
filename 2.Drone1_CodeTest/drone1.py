...
class Mission:
    def __init__(self):
        ...
        # Publisher
        self.local_pose_pub = rospy.Publisher('/drone1/mavros/setpoint_position/local', PoseStamped, queue_size=10)

        # Subscriber
        rospy.Subscriber('/drone1/mavros/state', State, self.stateCb)
        rospy.Subscriber('/drone1/mavros/home_position/home', HomePosition, self.homeCb)
        rospy.Subscriber('/drone1/mavros/local_position/pose', PoseStamped, self.LocalPositionCb)
        ...
        self.set_home_client = rospy.ServiceProxy('/drone1/mavros/cmd/set_home', CommandHome)
  
        # Gate Positions & Starting Position
        self.starting_position = Point (-4, 4, 0)
